...
const UpcomingModal = ({ setModalOpen }) => {
    ...
    return (
        <div>
            ...
            <div className="modal">
                <form onSubmit={handleSubmit} className="card-body bg-gray-700 mx-10 sm:mx-24 md:mx-40 lg:mx-96 rounded-2xl">
                    <h2 className='text-base md:text-2xl font-serif'>Subscribe to our newsletter <br /> We will let you know if films are restocked</h2>
                    ...
                    <div className='grid grid-cols-4 gap-4 items-center mt-3'>
                        <div className="modal-action mt-0 col-span-2 sm:col-span-1">
