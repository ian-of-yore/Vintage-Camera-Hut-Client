                    ...
                    <div className="hero" style={{ backgroundImage: `url(${bg03})` }}>
                        <div className="card h-[550px] glass w-8/12 mx-auto">
                            ...
                            <div className="card-body text-center">
                                <h2 className="text-3xl font-mono">Pre-owned! Perfected.</h2>
                                <p className='text-lg font-mono'>Save money on quality equipment when you buy second hand from us</p>
                            </div>
                        </div>
                    </div>
                ...
                <div id="slide2" className="carousel-item relative w-full h-5/6">
                    <div className="hero" style={{ backgroundImage: `url(${bg01})` }}>
                        <div className="card h-[550px] glass w-8/12 mx-auto">
                            ...
                            <div className="card-body text-center">
                                <h2 className="text-3xl font-mono">Trade In! Win!</h2>
                                <p className='text-lg font-mono'>Part-exchange your old equipment and put the money towards your latest purchase.</p>
                            </div>
                        </div>
                    </div>
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                ...
                <div id="slide3" className="carousel-item relative w-full h-5/6">
                    <div className="hero" style={{ backgroundImage: `url(${bg05})` }}>
                        <div className="card h-[550px] glass w-8/12 mx-auto">
                            ...
                            <div className="card-body text-center">
                                <h2 className="text-3xl font-mono">Find Your !The One!</h2>
                                <p className='text-lg font-mono'>Take advantage of our in-store services and speak to one of our expers today.</p>
                            </div>
                        </div>
                    </div>
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
